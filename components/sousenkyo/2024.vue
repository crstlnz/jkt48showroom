...
<template>
  <div class="mx-3 md:mx-4 bg-container p-3 md:p-4 rounded-xl">
    <div class="flex items-center gap-2 text-lg xl:text-xl font-semibold">
      ...
      <a href="https://ssk.jkt48.com/2024/id/vote" target="_blank" class="mx-auto text-sm block max-w-[400px] rounded-full bg-gradient-to-r from-pink-300 via-purple-300 to-cyan-300 px-3 pb-0.5 pt-0.5 text-center font-bold text-white shadow-lg">Vote</a>
    </div>
