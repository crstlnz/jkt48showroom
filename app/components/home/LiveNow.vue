  ...
  <div class="px-3 md:px-4">
    <ClientOnly>
      ...
      >
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex h-[245.5px] flex-col items-center justify-center gap-2 text-center text-xs max-sm:aspect-square sm:h-[230.88px] md:h-62.5 md:gap-3 md:text-sm lg:h-[270.55px] xl:h-[349.2px] 2xl:h-79.5">
          <Image class="mx-auto w-64 lg:w-72 max-w-[70%] md:max-w-[80%] aspect-5/4 object-contain" alt="No member onlive" :src="`${$imgCDN}/assets/svg/web/space_copy.svg`" sizes="320px" fit="fill" />
