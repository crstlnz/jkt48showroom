...
<template>
  <div class="space-y-3 sm:px-3 md:px-4 pb-5 max-sm:pb-8 max-sm:border-b border-color-1" :class="rootClass">
    <div class="flex gap-1.5 items-center max-sm:px-3" :class="headerClass" @click="$emit('headerClick')">
