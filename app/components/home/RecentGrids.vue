...
<template>
  ...
  >
    ...
    >
      <div v-for="recent in data.recents.slice(0, 6)" :key="recent.data_id" class="bg-container flex gap-2.5 rounded-xl p-3 md:p-3.5 max-sm:nth-[n+4]:hidden max-xl:nth-[n+5]:hidden">
