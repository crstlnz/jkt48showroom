...
<template>
  <div ref="element" class="roundedscrollbar space-y-4 overflow-y-auto" :style="{ height: fixedHeight ?? '' }">
    ...
    <div
      class="flex space-x-1 overflow-hidden rounded-xl bg-slate-200/70 dark:bg-dark-2 *:cursor-pointer [&>button]:flex-1 [&>button]:p-2 lg:[&>button]:p-2 [&>div]:flex-1"
    >
      <button
        type="button"
        class="transition-colors hover:bg-second-2/20"
        :class="{
