...
const content = computed(() => {
  return data.value?.content?.replaceAll('https://jkt48.com/upload/news', `${useRuntimeConfig().public.showroomApi ?? ''}https://jkt48.com/api/v1/storages/media/news/migrated`)?.replaceAll('color: #333333', '')?.replaceAll('color: #1f1f1f;', '')?.replaceAll('color: blue', '')?.replaceAll('color: #000000', '')
})
